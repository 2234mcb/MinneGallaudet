package minnie.gallaudet.edu.minnegallaudet;
...
public class MainActivity extends AppCompatActivity {
    ...
    private void addFlower() {
        ...
        //TASK 3: ADD THE BEE
        flowerImageView = (ImageView)
                layoutInflater.inflate(R.layout.seal, null);
    ...
    private void buildBee() {
        ...
        //TASK 3: ADD THE BEE
        beeImageView = (ImageView)
                layoutInflater.inflate(R.layout.bison, null);
